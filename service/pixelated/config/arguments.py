...
def parse_user_agent_args():
    ...
    parser.add_argument('--manhole', help='Run an interactive Python shell on port 8008',
                        action='store_true', default=False, dest='manhole')
...
def parse_register_args():
    ...
    parser.add_argument(
        '--invite-code', help='invite code to register a user, if required', dest='invite_code', default=None)
    return parser.parse_args()
